...
import boomvec.lsu.{BoomNonBlockingDCache, LSU, LSUCoreIO}
import boomvec.common.{BoomTileParams, MicroOp, BoomCoreParams, BoomModule}
...
class BoomLSUShim(implicit p: Parameters) extends BoomModule()(p)
  ...
  io.lsu.brupdate.b1 := (0.U).asTypeOf(new boomvec.exu.BrUpdateMasks)
